...
var main = (function (_globalCurrentAddress) {
    return function (p) {
        ...
        var mymodel = function mymodel(globalStore, _k12, _address163) {
            ...
            return function () {
                return sim_event(globalStore, function (globalStore, n_events) {
                    _addr.save(_globalCurrentAddress, _currentAddress);
                    return function () {
                        return _k12(globalStore, n_events);
                    };
        ...
        var sim_event = function sim_event(globalStore, _k5, _address164, state, stop_state, start_time, stop_time, r_0, r_1) {
            ...
            var _k11 = function (globalStore, rate) {
                _addr.save(_globalCurrentAddress, _currentAddress);
                var _k9 = function (globalStore, t) {
                    _addr.save(_globalCurrentAddress, _currentAddress);
                    ...
                    return function () {
                        return ad.scalar.lt(new_time, stop_time) ? _k5(globalStore, 0) : _k8(globalStore, undefined);
                    };
                };
                return function () {
                    return ad.scalar.neq(state, stop_state) ? sample_exp_max_t(globalStore, _k9, _address164.concat('_253'), rate, ad.scalar.sub(start_time, stop_time)) : Exponential(globalStore, function (globalStore, _result10) {
                        _addr.save(_globalCurrentAddress, _currentAddress);
                        return function () {
                            return sample(globalStore, _k9, _address164.concat('_255'), _result10);
                        };
                    }, _address164.concat('_254'), { a: rate });
                };
            };
            return function () {
                return ad.scalar.eq(state, 0) ? _k11(globalStore, r_0) : _k11(globalStore, r_1);
            };
        };
        var sample_exp_max_t = function sample_exp_max_t(globalStore, _k1, _address165, rate, max_time) {
            ...
            return function () {
                return Uniform(globalStore, function (globalStore, _result4) {
                    _addr.save(_globalCurrentAddress, _currentAddress);
                    return function () {
                        return sample(globalStore, function (globalStore, u) {
                            ...
                            return function () {
                                return Uniform(globalStore, function (globalStore, _result3) {
                                    _addr.save(_globalCurrentAddress, _currentAddress);
                                    return function () {
                                        return factor(globalStore, function (globalStore, _dummy2) {
                                            _addr.save(_globalCurrentAddress, _currentAddress);
                                            return function () {
                                                return _k1(globalStore, ad.scalar.div(ad.scalar.neg(ad.scalar.log(u)), rate));
                                            };
                                        }, _address165.concat('_260'), ad.scalar.neg(_result3.score(u)));
                                    };
                        ...
                        }, _address165.concat('_258'), _result4);
                    };
